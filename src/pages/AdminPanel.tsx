        ...
        <div className="dashboard-content">
          ...
          {selectedTab === 'analytics' && (
            <div className="space-y-6 mt-6">
              <DashboardHeader
                title="Tahlillar"
                subtitle="Platformaning to'liq tahlili va hisobotlar"
                icon={BarChart3}
                actions={
                    ...
                    {tierUpgradeRequests.length === 0 ? (
                      <Card>
                        <CardContent className="p-12 text-center">
                          ...
                          <p className="text-muted-foreground">Tarif yangilash so'rovlari yo'q</p>
                        </CardContent>
                      </Card>
                    ) : (
                          ...
                          <CardContent className="p-6">
                            ...
                            {request.reason && (
                              <div className="p-3 rounded-lg bg-muted/50 mb-4">
                                <p className="text-sm"><span className="font-medium">Sabab:</span> {request.reason}</p>
                              </div>
                            )}
                            {request.status === 'pending' && (
                              <div className="flex gap-2">
                                <Button
                                  onClick={() => updateTierRequestMutation.mutate({ id: request.id, status: 'approved' })}
                                ...
                                <Button
                                  onClick={() => updateTierRequestMutation.mutate({ id: request.id, status: 'rejected' })}
                                  disabled={updateTierRequestMutation.isPending}
                                  variant="destructive"
                                  size="sm"
                                >
