...
✅ TAYYOR! 20 slaydli professional pitch.`);
  ...
  const slides = [
    // Slide 1: Title
    {
      ...
      content: (
        <div className="text-center space-y-8 animate-fade-in">
          <div className="inline-block px-8 py-3 bg-gradient-to-r from-green-500 to-blue-600 rounded-full text-sm font-bold mb-4 animate-pulse shadow-lg">
            💰 SEED ROUND: $500K-$1M
          </div>
          ...
          <p className="text-xl text-gray-400 max-w-3xl mx-auto leading-relaxed">
            O'zbekiston's $2B+ e-commerce market uchun<br />
            to'liq avtomatlashtirilgan fulfillment va marketplace operatsiyalari
          </p>
          ...
          <div className="grid grid-cols-3 gap-6 max-w-4xl mx-auto mt-12">
            <div className="bg-gradient-to-br from-blue-600/20 to-blue-800/20 backdrop-blur-lg rounded-2xl p-6 border border-blue-500/30">
              <div className="text-4xl font-black text-blue-400 mb-2">$54M</div>
              <div className="text-sm text-gray-400">ARR Target (Year 3)</div>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-600/20 to-purple-800/20 backdrop-blur-lg rounded-2xl p-6 border border-purple-500/30">
              <div className="text-4xl font-black text-purple-400 mb-2">71:1</div>
          ...
          <div className="flex justify-center gap-4 mt-8 flex-wrap">
            <div className="flex items-center gap-2 bg-green-500/20 px-4 py-2 rounded-full border border-green-500/30">
              ...
              <span className="text-sm font-semibold text-green-400">41,842 Lines of Code</span>
            </div>
    ...
    // Slide 2: Problem
    {
      type: 'content',
      title: 'The Problem',
      subtitle: '50,000+ sellers in Uzbekistan losing 30% profit to operational chaos',
      content: (
          ...
          <div className="space-y-6">
            <div className="bg-red-500/10 border-2 border-red-500 rounded-2xl p-6 backdrop-blur-sm transform hover:scale-105 transition-all">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-red-400 mb-3">16 Hours/Day Manual Work</h3>
                  <p className="text-gray-300">Sellers spend entire days managing inventory, processing orders, and updating listings across multiple platforms</p>
                </div>
              </div>
            </div>
            <div className="bg-red-500/10 border-2 border-red-500 rounded-2xl p-6 backdrop-blur-sm transform hover:scale-105 transition-all">
              <div className="flex items-start gap-4">
                <AlertCircle className="w-12 h-12 text-red-400 flex-shrink-0" />
                <div>
                  <h3 className="text-2xl font-bold text-red-400 mb-3">30% Revenue Lost</h3>
                  <p className="text-gray-300">Stockouts, pricing errors, and fulfillment mistakes cost sellers nearly a third of potential revenue</p>
                </div>
              </div>
            </div>
          </div>
          <div className="space-y-6">
            <div className="bg-red-500/10 border-2 border-red-500 rounded-2xl p-6 backdrop-blur-sm transform hover:scale-105 transition-all">
              <div className="flex items-start gap-4">
                <AlertCircle className="w-12 h-12 text-red-400 flex-shrink-0" />
                <div>
                  <h3 className="text-2xl font-bold text-red-400 mb-3">5+ Platforms, Zero Integration</h3>
                  <p className="text-gray-300">Uzum, Wildberries, Yandex, Ozon, AliExpress - each with different rules, no unified system</p>
                </div>
              </div>
            </div>
            <div className="bg-gradient-to-br from-red-600 to-orange-600 rounded-2xl p-8 transform hover:scale-105 transition-all shadow-2xl">
              <h3 className="text-3xl font-black text-white mb-4">THE RESULT:</h3>
              <div className="space-y-3 text-lg text-white">
                <p className="flex items-center gap-2">❌ Revenue grows, profit shrinks</p>
                <p className="flex items-center gap-2">❌ Burnout and mistakes increase</p>
                <p className="flex items-center gap-2">❌ Can't scale without hiring</p>
                <p className="flex items-center gap-2">❌ Losing to competitors with better ops</p>
              </div>
            </div>
          </div>
        </div>
    ...
    // Slide 3: Solution
    {
      type: 'content',
      title: 'Our Solution',
      subtitle: 'AI-powered platform automating 70% of fulfillment & marketplace operations',
      content: (
        <div className="space-y-8 mt-12">
          {/* Main Value Prop */}
          <div className="bg-gradient-to-r from-blue-600/20 via-purple-600/20 to-green-600/20 backdrop-blur-lg rounded-3xl p-8 border border-blue-500/30 text-center">
            <h3 className="text-4xl font-black text-white mb-4">SellerCloudX = Fulfillment + AI Marketplace Operator</h3>
            <p className="text-xl text-gray-300">One platform to manage everything, powered by AI</p>
          </div>

          {/* Two Columns */}
          <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-gradient-to-br from-blue-600/20 to-blue-800/20 border-2 border-blue-500 rounded-2xl p-8 backdrop-blur-sm">
