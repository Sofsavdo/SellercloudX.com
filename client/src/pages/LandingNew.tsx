  ...
  const pricing = [
    {
      ...
      setupFee: '$699 bir martalik sozlash',
      description: "To'liq AI avtomatizatsiya",
      cta: '7 Kunlik Bepul Sinov',
    ...
    {
      name: 'Individual',
      badge: 'KATTA SOTUVCHILAR',
      badgeColor: 'bg-primary text-primary-foreground',
      extraBadge: 'VIP',
      price: 'SHAXSIY',
      priceNum: 0,
      period: '',
      priceSom: "Kelishiladi",
      commission: '2% dan boshlab',
      commissionColor: 'bg-primary/10 text-primary',
      setupFee: '$1599+ sozlash',
      description: 'Katta hajmli sotuvchilar',
      cta: 'Shaxsiy Taklif Olish',
